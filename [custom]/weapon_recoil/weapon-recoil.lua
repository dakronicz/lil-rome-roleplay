local weapons = {
	[GetHashKey('WEAPON_PISTOL')] = {recoil = 0.8, shake = 0.02}, 	--PISTOL	
	[GetHashKey('WEAPON_APPISTOL')] = {recoil = 0.8, shake = 0.03}, -- AP PISTOL
	[GetHashKey('WEAPON_SMG')] = {recoil = 0.4, shake = 0.03}, -- SMG
	[GetHashKey('WEAPON_CARBINERIFLE')] = {recoil = 0.4, shake = 0.03}, -- CARBINE RIFLE
	[GetHashKey('WEAPON_HEAVYRIFLE')] = {recoil = 0.4, shake = 0.025}, -- WEAPON_HEAVYRIFLE
	[GetHashKey('WEAPON_ASSAULTRIFLE')] = {recoil = 0.4, shake = 0.03}, -- ASSAULT RIFLE
	[GetHashKey('WEAPON_MACHINEPISTOL')] = {recoil = 0.8, shake = 0.03},-- MACHINE PISTOL
	[GetHashKey('WEAPON_MINISMG')] = {recoil = 1.0, shake = 0.10}, -- MINI SMG 
	[GetHashKey('WEAPON_TECPISTOL')] = {recoil = 1.0, shake = 0.10}, -- WEAPON_TECPISTOL
